 ...
 *
 * NOTICE OF LICENSE
 * Chemin : /themes/PRS010013/templates/cms
...
{block name='page_title'}
  {l s='Qui sommes-nous ?' d='Shop.Theme'}
{/block}
        ...
        <div class="store-item-container clearfix">
          ...
          <div class="col-md-5 col-sm-7 col-xs-12 store-description">
            ...
            {if $store.note || $store.phone || $store.fax || $store.email}
              <a data-toggle="collapse" href="#about-{$store.id}" aria-expanded="false" aria-controls="about-{$store.id}"><strong>{l s='Plus d\'informations' d='Shop.Theme'}</strong><i class="material-icons">&#xE409;</i></a>
            {/if}
          </div>
