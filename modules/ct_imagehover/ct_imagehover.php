...
class Ct_Imagehover extends Module
{	
	public function __construct()
	{
		$this->name = 'ct_imagehover';
		...
		$this->displayName = $this->trans('CT - Product Hover Image', array(), 'Modules.ImageHover');
	...
	{
		return parent::install() && $this->registerHook('displayCtHoverImage');
	}
	
	public function hookDisplayCtHoverImage($params) {
		
		if (!$this->isCached('ct_imagehover.tpl', $this->getCacheId($params['id_product']))) {
		...
		return $this->display(__FILE__, 'ct_imagehover.tpl', $this->getCacheId($params['id_product']));
	}
}