...
*/modules/ct_brandlogo/views/templates/hook
* NOTICE OF LICENSE
*
...
<div class="row">
	 <h1 class="h1 products-section-title">
		{if $display_link_brand}<a href="http://vintury.fr/index.php?id_category=137&controller=category" title="{l s='Vintury' d='Modules.Brandlist.Shop'}">{/if}
			<span>{l s='Cliquez-ici pour en savoir plus..' d='Modules.Brandlist.Shop'}</span>{l s='Les accessoires à Vin..' d='Modules.Brandlist.Shop'}
